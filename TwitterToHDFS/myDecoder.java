 ...
 */
public class myDecoder extends MessageDecoder<Message, String> {
  ...
  public CamusWrapper<String> decode(Message message) {
    ...
    String payloadEdit = "\"" + topicName.trim() + "\"," + "\"" + payloadString.trim().replaceAll("\"", "\\\\\"") + "\"\n";

    return new CamusWrapper<String>(payloadEdit, timestamp);
  }
}
